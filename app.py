...
يتضمن نافذة زر ومسار الذكاء الاصطناعي (POST /ai)
...
استيراد مكتبة Gemini الرسمية الجديدة
...
<body data-bs-theme="dark">  
    ...
    </div>  <!-- زر اسأل الذكاء الاصطناعي العائم -->  
{% if session.get('user_id') %}  
...
{% endblock %}''',  'register.html': '''{% extends "base.html" %}
...
{% endblock %}''',  'index.html': '''{% extends "base.html" %}
...
{% endblock %}''',  'create_task.html': '''{% extends "base.html" %}
...
{% endblock %}''',  'profile.html': '''{% extends "base.html" %}
...
{% endblock %}''',  'admin.html': '''{% extends "base.html" %}
...
مسار الذكاء الاصطناعي الجديد (POST /ai)
...
if not username or len(username) < 3 or len(username) > 50:  
    ...
    try:  
        ...
        if res.data and len(res.data) > 0:  
            ...
            flash('فشل إنشاء الحساب. تحقق من سياسات RLS في جدول users.', 'danger')  
    except Exception as e:  
